    ...
    public partial class VpsDetailsGeneral : FuseCPModuleBase
    {
        ...
        private ActionButton CreateActionButton(string command, string icon)
        {
            ...
            btn.Style = String.Format(
                ...
                PortalUtils.GetThemedImage(String.Format("Proxmox/{0}", icon)));
        ...
        protected void repButtons_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                if (command == "Snapshot")
                {
                    res = ES.Services.Proxmox.CreateSnapshot(PanelRequest.ItemID);
                }
                else
                {
                    // parse command
                    ...
                    // call services
                    res = ES.Services.Proxmox.ChangeVirtualMachineState(PanelRequest.ItemID, state);
                }
        ...
        protected void btnChangeHostname_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ResultObject res = ES.Services.Proxmox.UpdateVirtualMachineHostName(PanelRequest.ItemID,
                    hostname, false);
