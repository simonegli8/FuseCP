...
<div class="panel-body form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <span class="form-control">
                <asp:Literal ID="lblUsername" runat="server"></asp:Literal></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <asp:Label ID="lblAccountRef" runat="server" meta:resourcekey="lblAccountRef" Text="Account Ref:" AssociatedControlID="txtAccountRef" CssClass="col-sm-2"></asp:Label>
        <div class="col-sm-10">
            <asp:TextBox ID="txtAccountRef" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
    <div class="form-group">
        <asp:Label ID="lblHostBillClientId" runat="server" meta:resourcekey="lblHostBillClientId" Text="HostBill Client ID:" AssociatedControlID="txtHostBillClientId" CssClass="col-sm-2"></asp:Label>
        <div class="col-sm-10">
            <asp:Label ID="txtHostBillClientId" runat="server" CssClass="form-control"></asp:Label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <uc2:EmailControl ID="txtEmail" runat="server" CssClass="form-control"></uc2:EmailControl>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <uc2:EmailControl ID="txtSecondaryEmail" runat="server" RequiredEnabled="false" CssClass="form-control"></uc2:EmailControl>
        </div>
    </div>
    <div class="form-group">
