<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail100_Settings.ascx.cs" Inherits="SolidCP.Portal.ProviderControls.SmarterMail100_Settings" %>
...
<table cellpadding="7" cellspacing="0" width="100%">
    ...
    <tr>
        <td></td>
        <td>
            <asp:CheckBox runat="server" ID="cbInheritDefaultLimits" meta:resourcekey="cbInheritDefaultLimits" /></td>
    </tr>
    <tr>
        <td></td>
        <td>
