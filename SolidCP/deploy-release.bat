...
:Build
%SCPMSBuild% build.xml /target:Deploy /p:BuildConfiguration=Release /p:Version="1.5.0" /p:FileVersion="1.5.1" /p:VersionLabel="1.5.1" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%